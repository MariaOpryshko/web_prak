...
import ru.java.project.DAO.interfaces.CommonDAO;
...
@Repository
public abstract class CommonDAOImpl<T extends Template<ID>, ID extends Serializable> implements CommonDAO<T, ID> {
